...
export default function AllCourse() {
  ...
  const menu = (
    <Menu
      className={styles.SortMenuSize}
      items={[
        {
          key: '1',
          label: (
            <a target="_blank" rel="noopener noreferrer" href="https://www.antgroup.com">
              Kurs Qiyinligi buyicha
            </a>
          ),
        },
        {
        ...
        <div className={styles.Action}>
          <div className={styles.ActionSort}>
            <Dropdown overlay={menu} placement="bottom" arrow>
              <button className={styles.SortMenu} type="button"><BiSortAlt2 /> Tartiblash</button>
            </Dropdown>

          </div>
          <div className={styles.FormAction}>
            <form>
              <input type="text" id="header-search" name="s" placeholder='Kurslarni qidirish...' />
