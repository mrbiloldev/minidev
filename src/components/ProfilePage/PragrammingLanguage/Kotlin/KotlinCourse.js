...
import styles from './KotlinCourse.module.css'
    ...
    <div className={styles.Container}>
      ...
      <div className={styles.InfoLink}>
        ...
        <div className={styles.Link}>
          ...
          <p>
            <ul>
              <li>Docs: <a href={x}>Kotlin</a></li>
              <li><a href={x}>Kotlin Features</a></li>
      ...
      <div className={styles.CourseInfo}>
        ...
        Kotlinda yangimisiz? Bu yerdan boshlang
        ...
        <div className={styles.CourseGroup}>
          <div className={styles.Coursetext}>
            ...
            <div className={styles.ForText}>
              ...
              Kotlin va yulduzcha asoslarini o'rganing
