...
import styles from './RCourse.module.css'
import { BsChevronDown, BsChevronUp } from 'react-icons/bs'

export default function RCourse() {
    ...
    <div className={styles.Container}>
      ...
      <div className={styles.InfoLink}>
        <div className={styles.Info}>
          <p>R</p>
          <p>R  - bu statistik ma'lumotlarni qayta ishlash va grafikalar uchun dasturlash tili , shuningdek, GNU loyihasi doirasida bepul va ochiq manbali hisoblash muhiti.
          Dastlab, R. Ross Aihaka ( Ross Ihaka ) va Robert Gentleman ( ingliz . Robert Gentleman ) tomonidan ishlab chiqilgan (ismlarining birinchi harfi R); til va muhit R fondi tomonidan saqlanadi va ishlab chiqiladi.
          </p>
        </div>
        <div className={styles.Link}>
          ...
          <p>
            <ul>
              <li>Docs: <a href={x}> R</a></li>
              <li><a href={x}>R Features</a></li>
      ...
      <div className={styles.CourseInfo}>
        <div className={styles.TextInfo}>
          Rda yangimisiz? Bu yerdan boshlang
          ...
          <div className={styles.Coursetext}>
            ...
            <div className={styles.ForText}>
              ...
              <div className={styles.LessonText}>
                R va yulduzcha asoslarini o'rganing
