    ...
    <div className={styles.Container}>
      ...
      <div className={styles.InfoLink}>
        <div className={styles.Info}>
          <p>React</p>
          <p>React (ba'zan React.js yoki ReactJS ) foydalanuvchi interfeyslarini ishlab chiqish uchun ochiq manbali JavaScript kutubxonasi.
          React Facebook , Instagram va individual ishlab chiquvchilar va korporatsiyalar hamjamiyati tomonidan ishlab chiqilgan va qo'llab-quvvatlanadi.
          </p>
        </div>
        <div className={styles.Link}>
          ...
          <p>
            <ul>
              <li>Docs: <a href={x}> React</a></li>
              <li><a href={x}>React Features</a></li>
      ...
      <div className={styles.CourseInfo}>
        <div className={styles.TextInfo}>
          Reactda yangimisiz? Bu yerdan boshlang
          ...
          <div className={styles.Coursetext}>
            ...
            <div className={styles.ForText}>
              ...
              <div className={styles.LessonText}>
                React va yulduzcha asoslarini o'rganing
